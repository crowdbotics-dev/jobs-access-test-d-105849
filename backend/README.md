...
## Project Structure
    ...
    ├── jobs_access_test_d_105849  # Django project configurations
...
1. Clone this repo and `cd jobs_access_test_d_105849`
...
2. Clone this repo and `cd jobs_access_test_d_105849`
